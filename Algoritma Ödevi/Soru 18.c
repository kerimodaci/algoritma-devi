...
//int ile sayi1,sayi2 ve secim deðerlerini tanýmladýk.
//kullanýcýdan 2 sayý giriþi istedik ve scanf ile okuttuk.
//if,else ve else if ile denklemleri yazýp iþlemlerin sonuçlarýný ekrana yazdýrdýk.
